...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=bea80c14b34a63f6e26178b9a266020d&redirect_uri=http://localhost:8000/kakao/oauth">
        <li class="kakao"></li>
      </a>
      <li class="naver"></li>
