...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=503cfcdcdf40bb783d63510c7c4d3dcc&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code">
         <li class="kakao"></li>
      </a>
      <li class="naver"></li>
