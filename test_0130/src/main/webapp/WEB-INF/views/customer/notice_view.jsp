...
${map.bdto.bcontent }
						...
						<div class="viewContents"><img style="width:100%;" src="/upload/${map.bdto.bfile }"></div>
					</div>
						...
						<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<td><a href="notice_view?bno=${map.predto.bno}">${map.predto.btitle }</a></td>
								</tr>

								<tr>
									<th class="next">NEXT</th>
									<td><a href="notice_view?bno=${map.nextdto.bno}">${map.nextdto.btitle }</a></td>
								</tr>
							</tbody>
						</table>
					</div>
