		...
		<div id="outbox">		
			<div id="left">
				...
				<ul>	
					...
					<li><a href="#" id="leftNavi9">1:1문의</a></li>
					<li><a href="#" id="leftNavi8">회원정보 수정</a></li>
					<li><a href="/mypage/my_list" id="leftNavi7">회원전체리스트</a></li>
					<li class="last"><a href="#" id="leftNavi10">회원 탈퇴</a></li>
				</ul>			
			...
			<div id="contents">
				<div id="mypage">
					<h2><strong>회원전체리스트</strong><span>회원의 모든 정보를 출력합니다.</span></h2>
					...
					<div class="orderDivNm">
						<table summary="NO, 종류, 적립포인트, 적립날짜, 상태 순으로 현재 적립된 포인트를 조회 하실수 있습니다." class="orderTable2" border="1" cellspacing="0">
							...
							<col width="25%" class="tw20" />
							<col width="*" />
							<col width="20%" class="tnone" />
							<col width="20%" class="tw30" />
							</colgroup>
							<thead>
								<th scope="col" class="tnone">체크</th>
							...
							<tbody>
								<tr>
									<td class="tnone"><input type="checkbox" class="agree" /></td>
									<td><a href="#">aaa</a></td>
									<td>홍길동</td>
									<td class="tnone">14-05-31</td>
									<td>
										<ul class="state">
											<li><div class="nbtnMini iw83">비정규직</div></li>
										</ul>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<ul class="state">
											<li><div class="obtnMini iw83">정규직</div></li>
										</ul>
									</td>
								</tr>
